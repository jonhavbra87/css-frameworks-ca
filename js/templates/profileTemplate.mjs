...
export function profileTemplate(profileData) {
    ...
    profileContainer.classList.add("card", "bg-primary", "px-0", "mx-auto", "border", "border-3", "rounded", "position-relative", "col-12");
    ...
    followersDiv.classList.add('text-center', 'border', 'border-2', 'rounded-3', 'p-2', 'bg-secondary', 'text-white');
    ...
    followersText.classList.add('text-capitalize');
    ...
    imgContainer.classList.add("p-1", "col-8", "col-md-10");
    ...
    followingDiv.classList.add("text-center", "border", "border-2", "rounded-3", "p-2", "bg-secondary", "text-white");
